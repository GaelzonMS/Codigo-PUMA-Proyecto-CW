    ...
    if ($_SERVER["REQUEST_METHOD"] == 'POST')
    {
        ...
        if (isset($_POST['calificaciones']) && is_array($_POST['calificaciones']))
        {
            ...
            foreach ($_POST['calificaciones'] as $idUsuario => $calificacion)
            {
                ...
                //si el input viene vacio se guarda como un valor nulo en la base de datos
                if ($calificacion === "")
                {
                ...
                else
                {
                    ...
                    //esto previene errores de llave primaria si el alumno no habia subido archivo pero el docente lo califica
