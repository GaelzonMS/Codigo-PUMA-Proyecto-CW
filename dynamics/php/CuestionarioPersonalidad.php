...
<body>
    <div>
        <form method="POST" action="procesarTest.php">
            ...
            <div>
                <div>1</div>
                <div>Me resultan más fáciles los exámenes:</div>
                <div>
                    <div>
            ...
            <div>
                <div>3</div>
                <div>Entre estas 3 asignaturas elegiría:</div>
                <div>
                    <div>
            ...
            <div>
                <div>5</div>
                <div>Mi técnica para estudiar es:</div>
                <div>
                    <div>
            ...
            <div>
                <div>6</div>
                <div>Entre estos 3 trabajos elegiría:</div>
                <div>
                    <div>
            ...
            <div>
                <div>7</div>
                <div>Mi entretenimiento favorito es:</div>
                <div>
                    <div>
